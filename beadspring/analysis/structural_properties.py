...
def compute_structure_factor_fourier(
    positions_type1,
    positions_type2,
    box_size,
    k_min,
    ...
    grid_indices1 = np.mod(positions_type1 / box_size * grid_size, grid_size).astype(
        int
    )
    ...
    grid_indices2 = np.mod(positions_type2 / box_size * grid_size, grid_size).astype(
        int
    )
